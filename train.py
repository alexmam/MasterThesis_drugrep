...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        def train_step(x_batch):
            ...
            'print("{}: step {}, loss {:g}, latentLoss: {:g}, reconstructionLoss: {:g}, acc {:g}".format(time_str, step, loss, kldiv,CEloss, accuracy))'
        ...
        def dev_step(x_batch, writer=None):
            ...
            time_str = datetime.datetime.now().isoformat()
            'print("{}: step {}, loss {:g}, klDiv: {:g}, CE-loss: {:g}, acc {:g}".format(time_str, step, loss, kldiv,CEloss, accuracy))'
            if writer:
